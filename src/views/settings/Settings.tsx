  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-black dark:text-white font-sans flex flex-col">
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to reset all your configuration? This will permanently delete all your sources, bookmarks, and settings. This action cannot be undone."
