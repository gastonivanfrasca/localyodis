...
export const AdaptiveNavigation = ({ children }: AdaptiveNavigationProps) => {
  ...
  return (
    <div className="flex h-dvh w-full bg-white dark:bg-slate-950">
      {/* Desktop Sidebar - Optimized for space */}
      <aside className="hidden md:flex md:flex-col md:w-20 md:bg-white md:dark:bg-slate-950 md:shadow-lg md:shadow-gray-300 md:dark:shadow-white/10 md:border-r md:border-gray-200 md:dark:border-gray-700 md:sticky md:top-0 md:h-dvh">
