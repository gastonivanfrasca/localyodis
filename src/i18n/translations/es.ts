...
export const es: TranslationKeys = {
  ...
  // Feed
  'feed.upToDate': '¡Estás al día!',
  'feed.upToDateDescription': 'No hay artículos nuevos. Vuelve más tarde para ver más contenido.',
  ...
  'help.nav.iconLabel': 'Ayuda de navegación',
  'help.nav.title': 'Guía rápida',
  'help.nav.description': 'Aquí puedes ver para qué sirve cada botón de la barra inferior y los gestos disponibles en el feed.',
  'help.nav.buttonsTitle': 'Botones de la barra',
  'help.nav.buttons.homeAction': 'Inicio: vuelve al feed y sube al inicio.',
  'help.nav.buttons.bookmarks': 'Guardados: revisa tus artículos marcados.',
  'help.nav.buttons.help': 'Ayuda: abre esta guía cuando lo necesites.',
  'help.nav.buttons.search': 'Buscar: encuentra artículos en tus fuentes.',
  'help.nav.buttons.discover': 'Descubrir: agrega fuentes recomendadas.',
  'help.nav.buttons.menu': 'Menú: accede a ajustes y más opciones.',
  'help.nav.gesturesTitle': 'Gestos',
  'help.nav.gestures.hideItem': 'Desliza a la derecha un elemento para ocultarlo.',
  'help.nav.gestures.hideAll': 'Desliza a la izquierda en el feed para marcar todo como leído.',
