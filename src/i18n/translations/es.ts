...
export const es: TranslationKeys = {
  ...
  'discover.googleNews.title': 'Constructor RSS de Google News',
  'discover.googleNews.subtitle': 'Crea feeds RSS personalizados de Google News basados en tus intereses',
  'discover.predefinedSources': 'Fuentes de la Comunidad',
  'discover.predefinedSourcesSubtitle': 'Explora fuentes RSS curadas y sugeridas por la comunidad',
  'discover.selectCategories': 'Selecciona categorías arriba para explorar fuentes sugeridas por la comunidad',
  ...
  'googleNews.title': 'Generador RSS de Google Noticias',
  'googleNews.subtitle': 'Crea feeds RSS personalizados desde Google Noticias',
  'googleNews.interests': 'Intereses',
  'googleNews.interests.placeholder': 'Ingresa intereses separados por comas (ej: tecnología, deportes, política)',
  'googleNews.interests.help': 'Cada interés creará un feed RSS separado. Usa operadores avanzados como "frases exactas", site:dominio.com, o -excluir',
  'googleNews.source': 'fuente',
  'googleNews.sources': 'fuentes',
  'googleNews.operators': 'Operadores de Búsqueda',
  'googleNews.operators.and': 'Y (por defecto)',
  'googleNews.operators.or': 'O',
  'googleNews.operators.exclude': 'Excluir (-)',
  'googleNews.operators.exact': 'Frase exacta ("")',
  'googleNews.operators.site': 'Sitio específico (site:)',
  'googleNews.operators.intitle': 'En título (intitle:)',
  'googleNews.timeFilter': 'Filtro de Tiempo',
  'googleNews.timeFilter.all': 'Todo el tiempo',
  'googleNews.timeFilter.1h': 'Última hora',
  'googleNews.timeFilter.12h': 'Últimas 12 horas',
  'googleNews.timeFilter.1d': 'Último día',
  'googleNews.timeFilter.7d': 'Última semana',
  'googleNews.timeFilter.30d': 'Último mes',
  'googleNews.language': 'Idioma',
  'googleNews.country': 'País',
  'googleNews.preview': 'Vista previa URL',
  'googleNews.generate': 'Generar Feed RSS',
  'googleNews.addToSources': 'Agregar a Fuentes',
  'googleNews.examples': 'Ejemplos',
  'googleNews.examples.1': 'tecnología, deportes, política',
  'googleNews.examples.2': '"inteligencia artificial", cambio climático',
  'googleNews.examples.3': 'site:elpais.com economía, entretenimiento',
  'googleNews.examples.4': 'salud, ciencia, negocios',
  'googleNews.help': 'Construye feeds RSS personalizados de Google Noticias usando operadores de búsqueda avanzados',
