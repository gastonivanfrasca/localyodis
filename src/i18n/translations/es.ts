...
export const es: TranslationKeys = {
  ...
  'googleNews.searchTerms': 'Términos de Búsqueda',
  'googleNews.searchTerms.placeholder': 'Ingresa términos de búsqueda (ej: "cambio climático")',
  'googleNews.searchTerms.help': 'Usa comillas para frases exactas, OR para alternativas, - para excluir términos',
  ...
  'googleNews.examples.1': '"inteligencia artificial" OR "aprendizaje automático"',
  'googleNews.examples.2': 'cambio climático -política',
  'googleNews.examples.3': 'site:elpais.com tecnología',
  'googleNews.examples.4': 'intitle:"noticias de última hora"',
