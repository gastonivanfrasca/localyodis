...
export const es: TranslationKeys = {
  ...
  'push.sectionTitle': 'Notificaciones push',
  'push.sectionDescription': 'Registra este dispositivo para recibir alertas cuando una fuente seleccionada publique un artículo nuevo.',
  'push.enable': 'Activar notificaciones',
  'push.disable': 'Desactivar notificaciones',
  'push.refresh': 'Actualizar estado',
  'push.unsupported': 'Este dispositivo no soporta Web Push para esta app.',
  'push.permissionDenied': 'Las notificaciones están bloqueadas para esta app. Habilítalas desde el navegador.',
  'push.permissionDefault': 'No se concedió el permiso de notificaciones.',
  'push.status.enabled': 'Activadas',
  'push.status.disabled': 'Desactivadas',
  'push.status.denied': 'Bloqueadas',
  'push.status.unsupported': 'No compatible',
  'push.enabled': 'Las notificaciones push quedaron activadas en este dispositivo.',
  'push.disabled': 'Las notificaciones push se desactivaron para este dispositivo.',
  'push.subscribedSources': 'Fuentes con alertas',
  'push.sourceToggle': 'Alertas de la fuente',
  'push.sourceDescription': 'Recibe una notificación push cuando esta fuente publique algo nuevo.',
  'push.sourceEnabled': 'Las alertas de la fuente quedaron activadas.',
  'push.sourceDisabled': 'Las alertas de la fuente quedaron desactivadas.',
  'push.error.enable': 'No se pudieron activar las notificaciones push en este dispositivo.',
  'push.error.disable': 'No se pudieron desactivar las notificaciones push en este dispositivo.',
  'push.error.sync': 'No se pudo sincronizar el estado de las notificaciones.',
  'push.error.sourcePreference': 'No se pudo actualizar la preferencia de notificaciones de la fuente.',
  'push.keywordTitle': 'Filtrar por keywords',
  'push.keywordDescription': 'Recibe solo notificaciones cuyo título o resumen contenga alguna de estas keywords.',
  'push.keywordPlaceholder': 'Ej.: inteligencia artificial, openai, economía',
  'push.keywordHelp': 'Separalas con comas o saltos de línea. Si lo dejás vacío, recibís todas las alertas.',
  'push.keywordRequiresEnabled': 'Activá las notificaciones push para guardar este filtro.',
  'push.keywordSaved': 'Se guardó el filtro de keywords para este dispositivo.',
  'push.error.keywordFilters': 'No se pudo guardar el filtro de keywords.',
  ...
  'bookmarks.savedFromNotification': 'Artículo guardado en favoritos.',
  'bookmarks.alreadySaved': 'Este artículo ya está en favoritos.',
  'bookmarks.removedFromNotification': 'Artículo quitado de favoritos.',
