...
export const fr: TranslationKeys = {
  ...
  'googleNews.searchTerms': 'Termes de recherche',
  'googleNews.searchTerms.placeholder': 'Entrez les termes de recherche (ex: "changement climatique")',
  'googleNews.searchTerms.help': 'Utilisez des guillemets pour les phrases exactes, OR pour les alternatives, - pour exclure des termes',
  ...
  'googleNews.examples.1': '"intelligence artificielle" OR "apprentissage automatique"',
  'googleNews.examples.2': 'changement climatique -politique',
  'googleNews.examples.3': 'site:lemonde.fr technologie',
  'googleNews.examples.4': 'intitle:"actualités de dernière minute"',
