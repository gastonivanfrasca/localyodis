...
export const en: TranslationKeys = {
  ...
  'help.nav.iconLabel': 'Navigation help',
  'help.nav.title': 'Quick guide',
  'help.nav.description': 'Here is what each bottom bar button does and the gestures available in the feed.',
  'help.nav.buttonsTitle': 'Bottom bar buttons',
  'help.nav.buttons.homeAction': 'Home: return to the feed and scroll to the top.',
  'help.nav.buttons.bookmarks': 'Bookmarks: review saved items.',
  'help.nav.buttons.help': 'Help: open this guide at any time.',
  'help.nav.buttons.search': 'Search: find articles across your sources.',
  'help.nav.buttons.discover': 'Discover: add recommended sources.',
  'help.nav.buttons.menu': 'Menu: access settings and more options.',
  'help.nav.gesturesTitle': 'Gestures',
  'help.nav.gestures.hideItem': 'Swipe right on an item to hide it.',
  'help.nav.gestures.hideAll': 'Swipe left on the feed to mark everything as read.',
