...
export const en: TranslationKeys = {
  ...
  'googleNews.searchTerms': 'Search Terms',
  'googleNews.searchTerms.placeholder': 'Enter search terms (e.g., "climate change")',
  'googleNews.searchTerms.help': 'Use quotes for exact phrases, OR for alternatives, - to exclude terms',
  ...
  'googleNews.examples.1': '"artificial intelligence" OR "machine learning"',
  'googleNews.examples.2': 'climate change -politics',
  'googleNews.examples.3': 'site:reuters.com technology',
  'googleNews.examples.4': 'intitle:"breaking news"',
