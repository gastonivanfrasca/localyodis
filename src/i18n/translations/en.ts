...
export const en: TranslationKeys = {
  ...
  'push.sectionTitle': 'Push notifications',
  'push.sectionDescription': 'Register this device to receive alerts when a selected source publishes a new article.',
  'push.enable': 'Enable notifications',
  'push.disable': 'Disable notifications',
  'push.refresh': 'Refresh status',
  'push.unsupported': 'This device does not support Web Push for this app.',
  'push.permissionDenied': 'Notifications are blocked for this app. Enable them in your browser settings.',
  'push.permissionDefault': 'Notification permission was not granted.',
  'push.status.enabled': 'Enabled',
  'push.status.disabled': 'Disabled',
  'push.status.denied': 'Blocked',
  'push.status.unsupported': 'Unsupported',
  'push.enabled': 'Push notifications are enabled on this device.',
  'push.disabled': 'Push notifications were disabled for this device.',
  'push.subscribedSources': 'Sources with alerts',
  'push.sourceToggle': 'Source alerts',
  'push.sourceDescription': 'Receive a push notification when this source publishes something new.',
  'push.sourceEnabled': 'Source alerts enabled.',
  'push.sourceDisabled': 'Source alerts disabled.',
  'push.error.enable': 'We could not enable push notifications on this device.',
